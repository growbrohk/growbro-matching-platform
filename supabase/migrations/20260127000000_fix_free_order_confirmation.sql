-- Migration: Fix FREE ($0) booking finalize to immediately confirm orders
-- This ensures confirmation email triggers fire reliably for free orders

-- ============================================================================
-- 1. UPDATE payment_method CONSTRAINT TO ALLOW 'free'
-- ============================================================================
...
CHECK (payment_method IS NULL OR payment_method IN ('stripe', 'payme', 'fps', 'free'));

-- ============================================================================
-- 2. UPDATE create_event_booking RPC FUNCTION
-- ============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    CASE WHEN p_total_amount <= 0 THEN NOW() ELSE NULL END,
    CASE WHEN p_total_amount <= 0 THEN NOW() ELSE NULL END
  )
