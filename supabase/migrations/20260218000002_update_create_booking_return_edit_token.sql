-- Migration: Update create_event_booking to return edit_token
-- 
-- Goal:
-- - Change create_event_booking return type from UUID to JSONB
-- - Return {order_id, edit_token} so frontend can store edit_token
--
-- ============================================================================
-- DROP OLD FUNCTION FIRST (cannot change return type with CREATE OR REPLACE)
-- ============================================================================

-- Drop the old function with UUID return type
-- Error message shows exact signature: create_event_booking(uuid,jsonb,uuid,text,text,text,text,text,jsonb)
DROP FUNCTION IF EXISTS create_event_booking(uuid, jsonb, uuid, text, text, text, text, text, jsonb) CASCADE;

-- ============================================================================
-- CREATE create_event_booking FUNCTION WITH JSONB RETURN TYPE
-- ============================================================================
