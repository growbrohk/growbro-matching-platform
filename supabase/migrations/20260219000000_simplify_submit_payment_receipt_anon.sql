-- Migration: Simplify submit_payment_receipt RPC for incognito/anon users
-- 
-- Goal:
-- - Remove all auth gates (JWT email, buyer_user_id checks)
-- - Only use edit_token for authorization
-- - Allow incognito users to submit receipts without any authentication
-- - Brutally simple: edit_token is the ONLY security boundary
--
-- ============================================================================
...
-- ============================================================================
-- CREATE SIMPLIFIED submit_payment_receipt RPC FUNCTION
-- ============================================================================
...
COMMENT ON FUNCTION public.submit_payment_receipt IS 
  'Submits a payment receipt for PayMe/FPS orders using edit_token for authorization. Sets payment_status=''submitted'' but does NOT mark as paid. Only host confirmation can mark as paid. Works for incognito/anon users - edit_token is the ONLY security boundary.';
