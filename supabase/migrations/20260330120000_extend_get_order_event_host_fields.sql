-- Extend get_order_with_event_and_tickets for host order detail:
-- orders: metadata, fulfillment_status, order_no
-- order_items: metadata, ticket_type_access_variant_id, access_variant (join)
