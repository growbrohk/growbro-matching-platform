-- Include product primary image URL in checkout add-ons payload (for UI preview)
...
COMMENT ON FUNCTION get_event_addons_for_checkout IS 'Returns add-on products for event checkout (includes product_image_url for UI). Public for published events.';
